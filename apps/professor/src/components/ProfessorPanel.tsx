...
export type Tab = "inicio" | "cursos" | "aulas" | "materiais" | "questoes" | "simulados" | "duvidas" | "alunos" | "discursivas";
...
export function ProfessorPanel({ initialTab = "inicio" }: { initialTab?: Tab }) {
  ...
  /** Troca de aba com deep-linking: atualiza a URL sem remontar o painel. */
  function setTab(next: Tab) {
    setTabState(next);
    if (typeof window !== "undefined") {
      window.history.pushState({}, "", next === "inicio" ? "/" : `/${next}`);
    }
  }
  ...
  useEffect(() => {
    function syncFromLocation() {
      ...
      setTabState(found ? found.id : "inicio");
    }
